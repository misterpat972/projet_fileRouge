            ...
            <div class="col-md-8 mt-5">
                ...
                <form action="" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" id="nom_evenement" name="nom_evenement" placeholder="" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label for="description_evenement">Description de l'évenement</label>
                        <!-- input description de l'évènement -->
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="description_evenement"></textarea>

                    </div>
                    <div class="form-group">
                        <label for="date_evenement">Date de l'évènement</label>
                        <!-- input date de l'évènement -->
                        <input type="date" id="date_evenement" name="date_evenement" placeholder="" class="form-control" required>
                    </div>
                    ...
                    <div class="form-group mt-3">
                        <a href="<?= URL . "ajouterEvenement" ?>"><input type="submit" name="valid_evenement" value="Ajouter" class="btn btn-primary"></a>                       
